...
+ What is the difference between 10 fold cross validation and a random holdout when splitting data?
...
Write a paragraph describing in detail for each step of the CRISP-DM, the decisions and actions your team took to complete your final project. The CRisp-DM steps are as follows, please list at least two items for each step.
